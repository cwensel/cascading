...
public class ParquetTupleSchemeTest
  ...
  final String parquetInputPath = BUILD + "/ParquetTupleIn/names-parquet-in";
  final String txtOutputPath = BUILD + "/ParquetTupleOut/names-txt-out";
  ...
  public void testReadPattern() throws Exception
    ...
    String multiLevelGlobPattern = BUILD  +"/ParquetTupleIn/**/*";
  ...
  public void testFieldProjection() throws Exception
    ...
    Flow flow = new Hadoop2MR1FlowConnector().connect( "namecp", source, sink, assembly );
