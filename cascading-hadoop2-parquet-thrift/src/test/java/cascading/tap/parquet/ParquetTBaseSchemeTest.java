...
public class ParquetTBaseSchemeTest
  ...
  final String txtInputPath = BUILD+"/../../../../cascading-hadoop2-parquet/src/test/resources/names.txt";
  ...
  public void testWrite() throws Exception
    ...
    Hadoop2MR1FlowConnector hadoopFlowConnector = new Hadoop2MR1FlowConnector();
