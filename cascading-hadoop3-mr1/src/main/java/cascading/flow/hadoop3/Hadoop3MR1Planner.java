...
/**
 * Class Hadoop3MR1Planner is the core Hadoop MapReduce planner used by default through the {@link cascading.flow.hadoop3.Hadoop3MR1FlowConnector}.
 * <p>
 * Notes:
 * <p>
 ...
 * on a map properties object before constructing a new {@link cascading.flow.hadoop3.Hadoop3MR1FlowConnector}.
 * <p>
 ...
 */
public class Hadoop3MR1Planner extends HadoopPlanner
  {
  /** Field LOG */
  private static final Logger LOG = LoggerFactory.getLogger( Hadoop3MR1Planner.class );
