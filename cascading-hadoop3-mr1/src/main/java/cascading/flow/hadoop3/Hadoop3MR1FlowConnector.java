...
/**
 * Use the Hadoop3MR1FlowConnector to link source and sink {@link cascading.tap.Tap} instances with an assembly of {@link cascading.pipe.Pipe} instances into
 ...
 */
public class Hadoop3MR1FlowConnector extends FlowConnector
  {
  /**
   ...
   */
  public Hadoop3MR1FlowConnector()
    {
    }
  ...
  public Hadoop3MR1FlowConnector( Map<Object, Object> properties )
    {
    super( properties );
    }
  ...
  public Hadoop3MR1FlowConnector( RuleRegistrySet ruleRegistrySet )
    {
  ...
  public Hadoop3MR1FlowConnector( Map<Object, Object> properties, RuleRegistrySet ruleRegistrySet )
    {
