...
//      exception.printStackTrace();
  ...
  public void testCombinedPartitionTap() throws Exception
    ...
    Tap partitionTap = getPlatform().getDelimitedFile( new Fields( "lower" ), "+", getOutputPath( getTestName() + "/partitioned" ), SinkMode.REPLACE );
    ...
    Tap sink = getPlatform().getDelimitedFile( new Fields( "number", "lower"), "+", getOutputPath( getTestName() + "/final" ), SinkMode.REPLACE );
...
//    System.out.println( message + ": " + Arrays.toString( actual ) );
  ...
  public void testPrepareResource() throws Exception
    ...
    {
    @Override
    public boolean prepareResourceForRead( JobConf conf ) throws IOException
      {
