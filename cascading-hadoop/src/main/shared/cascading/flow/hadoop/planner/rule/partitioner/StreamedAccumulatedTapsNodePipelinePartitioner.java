...
import static cascading.flow.planner.rule.PlanPhase.PipelineNodes;

/**
 *
 */
public class StreamedAccumulatedTapsNodePipelinePartitioner extends RulePartitioner
  {
  public StreamedAccumulatedTapsNodePipelinePartitioner()
    {
    super(
      PipelineNodes,
