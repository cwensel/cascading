...
/**
 * This rule is a compliment to GroupNonBlockingHashJoinTransformRule and is intended
 * to prevent a HashJoin from landing in a Reducer until reduce side HashJoins are supported.
 */
public class PartitionGroupNonBlockingHashJoinExpression extends RuleExpression
  {
  public PartitionGroupNonBlockingHashJoinExpression()
    {
    super(
