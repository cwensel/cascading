 ...
 *
 */
public class BalanceNonSafeSplitTransformer extends RuleTempTapInsertionTransformer
  {
  public BalanceNonSafeSplitTransformer()
    {
    super(
      BalanceAssembly,
      new BalanceNonSafeSplitExpression()
    );
    }
  }
