...
public class PartitionTap extends BasePartitionTap<Configuration, RecordReader, OutputCollector>
  ...
  protected String getCurrentIdentifier( FlowProcess<? extends Configuration> flowProcess )
    ...
    if( identifier == null )
      ...
      throw new TapException( "unable to retrieve the current file being processed, '" + MultiInputSplit.CASCADING_SOURCE_PATH + "' was lost or not set by " + MultiInputSplit.class.getName() );
      }
