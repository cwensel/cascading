...
public class Hadoop3TezPlatform extends BaseHadoopPlatform<TezConfiguration>
  ...
  public FlowConnector getFlowConnector( Map<Object, Object> properties )
    {
    return new Hadoop3TezFlowConnector( properties );
    }
  ...
  public FlowProcess getFlowProcess()
    {
    return new Hadoop3TezFlowProcess( FlowSession.NULL, null, getConfiguration() );
    }
...
//      defaultConf.set( TezConfiguration.TEZ_TASK_LOG_LEVEL, "DEBUG" );
    ...
    Hadoop3TezPlanner.copyProperties( configuration, globalProperties ); // copy any external properties

    Hadoop3TezPlanner.copyConfiguration( properties, configuration ); // put all properties on the jobconf
