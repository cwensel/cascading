...
public class Hadoop3TezFlowConnector extends FlowConnector
  ...
  public Hadoop3TezFlowConnector( Map<Object, Object> properties )
    {
    super( properties );
    }
  ...
  public Hadoop3TezFlowConnector( Map<Object, Object> properties, RuleRegistrySet ruleRegistrySet )
    {
  ...
  protected RuleRegistrySet createDefaultRuleRegistrySet()
    {
    return new RuleRegistrySet( new NoHashJoinHadoop3TezRuleRegistry(), new HashJoinHadoop3TezRuleRegistry() );
    }
  }
