...
import cascading.flow.tez.planner.rule.expressiongraph.BottomUpConsecutiveBoundariesTriangleExpressionGraph;
 ...
 *
 */
public class BottomUpJoinedBoundariesTriangleNodePartitioner extends ExpressionRulePartitioner
  {
  public BottomUpJoinedBoundariesTriangleNodePartitioner()
    {
    super(
      PartitionNodes,
      ...
      new RuleExpression(
        ...
        new BottomUpConsecutiveBoundariesTriangleExpressionGraph()
      ),
