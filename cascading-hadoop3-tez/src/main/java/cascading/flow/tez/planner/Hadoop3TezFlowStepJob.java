...
public class Hadoop3TezFlowStepJob extends FlowStepJob<TezConfiguration>
  ...
  public Hadoop3TezFlowStepJob( ClientState clientState, BaseFlowStep<TezConfiguration> flowStep, TezConfiguration currentConf, DAG dag )
    {
  ...
  protected void internalNonBlockingStart() throws IOException
    ...
    try
      ...
      tezClient = TezClient.create( flowStep.getName(), workingConf, ( (Hadoop3TezFlowStep) flowStep ).getAllLocalResources(), null );
  ...
  String createStepStagingPath()
    ...
    String flowStagingPath = ( (Hadoop3TezFlow) flowStep.getFlow() ).getFlowStagingPath();
