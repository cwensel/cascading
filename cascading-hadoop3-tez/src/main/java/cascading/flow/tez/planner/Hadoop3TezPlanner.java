...
public class Hadoop3TezPlanner extends FlowPlanner<Hadoop3TezFlow, TezConfiguration>
  ...
  public void initialize( FlowConnector flowConnector, Map<Object, Object> properties )
    ...
    if( applicationJarPath == null )
      ...
      if( type == null )
        type = HadoopUtil.findMainClass( Hadoop3TezPlanner.class );
  ...
  @Override
  protected Hadoop3TezFlow createFlow( FlowDef flowDef )
    {
    return new Hadoop3TezFlow( getPlatformInfo(), getDefaultProperties(), getDefaultConfig(), flowDef );
    }
  ...
  public FlowStepFactory<TezConfiguration> getFlowStepFactory()
    ...
    return new BaseFlowStepFactory<TezConfiguration>( getFlowNodeFactory() )
      ...
      public FlowStep<TezConfiguration> createFlowStep( ElementGraph stepElementGraph, FlowNodeGraph flowNodeGraph )
        {
        return new Hadoop3TezFlowStep( stepElementGraph, flowNodeGraph );
        }
      };
    }
