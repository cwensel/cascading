 ...
 *
 */
public class Hadoop3TezStreamGraph extends NodeStreamGraph
  {
  private static final Logger LOG = LoggerFactory.getLogger( Hadoop3TezStreamGraph.class );
  ...
  public Hadoop3TezStreamGraph( Hadoop3TezFlowProcess currentProcess, FlowNode flowNode, Map<String, LogicalInput> inputMap, Map<String, LogicalOutput> outputMap )
    {
  ...
  protected void buildGraph()
    ...
    Hadoop3TezFlowProcess tezProcess = (Hadoop3TezFlowProcess) flowProcess;
    ...
    for( FlowElement flowElement : accumulated )
      ...
      FlowProcess flowProcess = conf == null ? tezProcess : new Hadoop3TezFlowProcess( tezProcess, conf );
