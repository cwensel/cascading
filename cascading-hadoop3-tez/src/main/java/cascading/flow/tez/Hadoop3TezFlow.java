 ...
 * <p>
 * HadoopFlow must be created through a {@link cascading.flow.tez.Hadoop3TezFlowConnector} instance.
 * <p>
...
public class Hadoop3TezFlow extends BaseFlow<TezConfiguration>
  ...
  public Hadoop3TezFlow( PlatformInfo platformInfo, Map<Object, Object> properties, TezConfiguration flowConf, FlowDef flowDef )
    {
  ...
  public FlowProcess<TezConfiguration> getFlowProcess()
    {
    return new Hadoop3TezFlowProcess( getFlowSession(), null, getConfig() );
    }
  ...
  private void copyArtifactsToRemote()
    ...
    for( FlowStep<TezConfiguration> flowStep : getFlowSteps() )
      ( (Hadoop3TezFlowStep) flowStep ).syncArtifacts();
    }
