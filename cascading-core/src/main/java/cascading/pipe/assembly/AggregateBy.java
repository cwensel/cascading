...
public class AggregateBy extends SubAssembly
  {
  @Deprecated
  /**deprecated, use AGGREGATE_BY_CAPACITY instead.*/
  ...
  @Deprecated
  public static final int DEFAULT_THRESHOLD = AggregateByProps.AGGREGATE_BY_DEFAULT_CAPACITY;
    ...
    public void prepare( final FlowProcess flowProcess, final OperationCall<CompositeFunction.Context> operationCall )
      ...
      if( capacity == 0 )
        ...
        if( cacheCapacity == null )
          cacheCapacity = flowProcess.getIntegerProperty( AGGREGATE_BY_THRESHOLD );
