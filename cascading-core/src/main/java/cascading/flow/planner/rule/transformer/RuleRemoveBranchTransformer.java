...
public class RuleRemoveBranchTransformer extends RuleTransformer
  ...
  public RuleRemoveBranchTransformer( PlanPhase phase, RuleExpression ruleExpression )
    ...
    if( subGraphTransformer != null )
      flowGraphTransformer = new RemoveBranchGraphTransformer( subGraphTransformer, ruleExpression.getMatchExpression() );
    else if( contractedTransformer != null )
      flowGraphTransformer = new RemoveBranchGraphTransformer( contractedTransformer, ruleExpression.getMatchExpression() );
    else
      flowGraphTransformer = new RemoveBranchGraphTransformer( ruleExpression.getMatchExpression() );
    }
  }
