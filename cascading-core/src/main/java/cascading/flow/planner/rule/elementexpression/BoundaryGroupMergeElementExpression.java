 ...
 *
 */
public class BoundaryGroupMergeElementExpression extends OrElementExpression
  {
  public BoundaryGroupMergeElementExpression()
    {
    super(
  ...
  public BoundaryGroupMergeElementExpression( ElementCapture capture )
    {
    super( capture,
      new FlowElementExpression( Group.class ),
      new FlowElementExpression( Merge.class ),
  ...
  public BoundaryGroupMergeElementExpression( TypeExpression.Topo topo )
    {
    super(
  ...
  public BoundaryGroupMergeElementExpression( ElementCapture capture, TypeExpression.Topo topo )
    {
    super( capture,
      new FlowElementExpression( Group.class, topo ),
      new FlowElementExpression( Merge.class, topo ),
