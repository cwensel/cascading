 ...
 *
 */
public class JSONBuildAsFunctionTest extends CascadingTestCase
  {
  @Test
  public void testBuildAsFunction() throws Exception
    {
    ...
    TupleEntry arguments = new TupleEntry( argumentFields, Tuple.size( 6 ) );
    ...
    JSONBuildAsFunction function = new JSONBuildAsFunction( fields, spec );
