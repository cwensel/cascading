...
import cascading.flow.planner.iso.expression.OrdinalScopeExpression;
 ...
 *
 */
public class BalanceBoundariesSplitSelfCoGroupExpression extends RuleExpression
  {
  public BalanceBoundariesSplitSelfCoGroupExpression()
    {
    super(
      ...
      new ExpressionGraph()
        .arcs(
          new BoundariesElementExpression( TypeExpression.Topo.SplitOnly ),
          new FlowElementExpression( CoGroup.class, TypeExpression.Topo.SpliceOnly )
        ),

      new ExpressionGraph()
        .arc(
          and( ElementCapture.Primary, new FlowElementExpression( Pipe.class ), not( new FlowElementExpression( Boundary.class ) ) ),
          OrdinalScopeExpression.NOT_ORDINAL_ZERO,
