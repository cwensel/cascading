...
import cascading.flow.tez.planner.rule.partitioner.TopDownSplitJoinBoundariesNodeRePartitioner;
 ...
 * {@link NoHashJoinHadoop2TezRuleRegistry} via the appropriate
 * {@link cascading.flow.FlowConnector} constructor.
 *
 */
public class HashJoin2Hadoop2TezRuleRegistry extends RuleRegistry
  {
  public HashJoin2Hadoop2TezRuleRegistry()
    {
//    enableDebugLogging();
...
//    addRule( new BoundaryBalanceGroupSplitMergeGroupTransformer() ); // causes AssemblyHelpersPlatformTest#testSameSourceMerge to hang
    ...
    addRule( new TopDownSplitJoinBoundariesNodeRePartitioner() ); // testCoGroupSelf
