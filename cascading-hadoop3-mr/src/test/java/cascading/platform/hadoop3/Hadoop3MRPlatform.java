...
public class Hadoop3MRPlatform extends BaseHadoopPlatform<JobConf>
  ...
  public FlowConnector getFlowConnector( Map<Object, Object> properties )
    {
    return new Hadoop3MRFlowConnector( properties );
    }
...
//      conf.set( "yarn.scheduler.capacity.root.default.capacity", "100" );
    ...
    Hadoop3MRPlanner.copyProperties( configuration, globalProperties ); // copy any external properties

    Hadoop3MRPlanner.copyConfiguration( properties, configuration ); // put all properties on the jobconf
    }
  }
