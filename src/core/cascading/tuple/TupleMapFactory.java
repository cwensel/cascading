...
import cascading.util.CascadingFactory;
 ...
 * <p/>
 * The {@link Map} classes returned must take a {@link Tuple} as a key, and a {@link Collection} of Tuples as
 ...
 * <p/>
 * The default implementation for the Hadoop platform is the {@link cascading.tuple.hadoop.HadoopTupleMapFactory}
 * which created a {@link cascading.tuple.hadoop.HadoopSpillableTupleMap} instance.
 * <p/>
 * The class {@link SpillableTupleMap} may be used as a base class.
 *
 * @see SpillableTupleMap
 * @see cascading.tuple.hadoop.HadoopTupleMapFactory
 * @see TupleCollectionFactory
 * @see cascading.tuple.hadoop.HadoopTupleCollectionFactory
 */
