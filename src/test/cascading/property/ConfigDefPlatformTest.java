...
public class ConfigDefPlatformTest extends PlatformTestCase
  ...
  static class LocalConfigDefScheme extends cascading.scheme.local.TextLine
    {

    LocalConfigDefScheme( Fields sourceFields )
      {
      super( sourceFields );
      }
  ...
  static class HadoopConfigDefScheme extends cascading.scheme.hadoop.TextLine
    {

    HadoopConfigDefScheme( Fields sourceFields )
      {
      super( sourceFields );
      }
  ...
  public void testTapSourceConfigDef() throws IOException
    ...
    if( getPlatform() instanceof LocalPlatform )
      scheme = new LocalConfigDefScheme( new Fields( "line" ) );
    else
      scheme = new HadoopConfigDefScheme( new Fields( "line" ) );
