...
public class EachEachPipeAssemblyPlatformTest extends PipeAssemblyTestBase
  ...
  public static Test suite() throws Exception
    ...
    for( String name : pipes.keySet() )
      makeSuites( properties, buildOpPipes( properties, name, pipes.get( name ), new EachAssemblyFactory(), RHS_ARGS_FIELDS, RHS_DECL_FIELDS, RHS_SELECT_FIELDS, RHS_VALUE ), suite, EachEachPipeAssemblyPlatformTest.class );

    return suite;
    }

  public EachEachPipeAssemblyPlatformTest( Properties properties, String displayName, String name, Pipe pipe )
    {
