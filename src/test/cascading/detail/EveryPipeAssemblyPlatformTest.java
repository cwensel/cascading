...
public class EveryPipeAssemblyPlatformTest extends PipeAssemblyTestBase
  ...
  public static Test suite() throws Exception
    ...
    makeSuites( properties, buildOpPipes( properties, null, new Pipe( "every" ), new EveryAssemblyFactory(), OP_ARGS_FIELDS, OP_DECL_FIELDS, OP_SELECT_FIELDS, OP_VALUE ), suite, EveryPipeAssemblyPlatformTest.class );
