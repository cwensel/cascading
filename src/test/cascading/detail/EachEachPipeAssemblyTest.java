...
public class EachEachPipeAssemblyTest extends PipeAssemblyTestBase
  {
  ...
  public static Test suite() throws Exception
    ...
    for( String name : pipes.keySet() )
      makeSuites( properties, buildOpPipes( properties, name, pipes.get( name ), new EachAssemblyFactory(), RHS_ARGS_FIELDS, RHS_DECL_FIELDS, RHS_SELECT_FIELDS, RHS_VALUE ), suite, EachEachPipeAssemblyTest.class );

    return suite;
    }

  public EachEachPipeAssemblyTest( Properties properties, String name, Pipe pipe )
    {
