...
public class DistCacheTapPlatformTest extends PlatformTestCase implements Serializable
  ...
  public void testHashJoinDistCacheTapRHS() throws Exception
    ...
    Tap sourceUpper = ( (BaseHadoopPlatform) getPlatform() ).getDistCacheTap( (Hfs) getPlatform().getTextFile( new Fields( "offset", "line" ), inputFileUpper ) );
  ...
  public void testHashJoinDistCacheTapLHS() throws Exception
    ...
    Tap sourceLower = ( (BaseHadoopPlatform) getPlatform() ).getDistCacheTap( (Hfs) getPlatform().getTextFile( new Fields( "offset", "line" ), inputFileLower ) );
  ...
  public void testGlobSupport() throws Exception
    ...
    Tap sourceLower = getPlatform().getTextFile( new Fields( "offset", "line" ), inputFileLower );
    Tap sourceUpper = ( (BaseHadoopPlatform) getPlatform() ).getDistCacheTap( (Hfs)
